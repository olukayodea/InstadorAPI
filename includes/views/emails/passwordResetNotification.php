	...
	<table width='630'  cellspacing='0' style='border: solid 20px #f3f3f3; margin:40px auto; background-color:#fff;' align='center'>
		...
		<tr>
			<td colspan='3'  align='center'>
                ...
                <p>We noticed that you recently requested for a new password, please find below your activation pin to complete this request</p>
                <h1><strong><?php echo $otp; ?></strong></h1>
